...
function App() {
    ...
    const NETWORK_ID = "0x61"; // bnb Testnet Chain ID
    ...
    const checkNetwork = async (provider) => {
        ...
        try {
            ...
            if (network.chainId !== parseInt(NETWORK_ID, 16)) {
                setNetworkError("Please switch to the bnb testnet testnet.");
            } else {
                setNetworkError("");
            }
        } catch (error) {
                ...
                params: [
                    {
                        ...
                        blockExplorerUrls: ["https://testnet-explorer.bnbchain.org"],
                    },
                ],
            });
        } catch (addError) {
